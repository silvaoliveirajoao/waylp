...
export default function Solutions() {
    return (
        <div id="solutions" className="container flex flex-col items-center justify-center my-6 px-4 gap-6">
                ...
                {/* primeiro: */}
                    <div className="card card-compact bg-white w-80 shadow-xl lg:card-normal items-center">
                        ...
                        <div className="card-body items-center text-center">
                            ...
                            <div className="card-actions">
                                <button className="btn btn-wide bg-teal-700 text-white border-teal-600">Quero saber mais!</button>
                            </div>
                        </div>
                    </div>
                    {/* segundo: */}
                    <div className="card card-compact bg-white w-80 shadow-xl lg:card-normal">
                        <figure className="px-10 pt-10">
                            <Image
