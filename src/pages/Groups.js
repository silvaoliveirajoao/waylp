...
export default function Groups() {
    return (
        <div id="groups" className="container w-[23rem] bg-gray-200 rounded-3xl flex flex-col justify-center items-center shadow-2xl shadow-gray-600 p-6 gap-6 sm:w-[23rem] md:w-4/5 md:flex-row md:flex-wrap xl:flex-row">
            ...
            <div id="carousel" className="carousel carousel-center bg-gray-300 rounded-box w-72 h-96 max-w-md space-x-4">
            ...
            <div id="dropdowns" className="flex flex-col gap-3 md:w-[412px] lg:hidden">
                <div tabIndex={0} className="collapse collapse-arrow bg-gray-300 border">
                    <div className="collapse-title text-base font-medium">Como funcionam os grupos da Way?</div>
                ...
                <div tabIndex={1} className="collapse collapse-arrow bg-gray-300 border">
            ...
            <div id="buttons" className="hidden lg:flex lg:gap-8 xl:w-[1200px] xl:justify-center">
                <button className="btn btn-active btn-ghost">Quais são os próximos grupos</button>
                <button className="btn btn-active btn-ghost">Tenho interesse em participar dos grupos.</button>
            </div>
        </div>
    )
}